...
#ifndef _COPPER_TAG_LEVMARQ_H_
#define _COPPER_TAG_LEVMARQ_H_
...
namespace CopperTag {
    ...
    */
    ...
    bool LevMarq<T>::step(F_z_x f_z_x, F_z_J f_J){
        ...
        if (_verbose) {
            std::cout<<std::setprecision(5) <<"Curr Error="<<currErr<<" AErr(prev-curr)="<<prevErr-currErr<<" gain="<<gain<<" dumping factor="<<mu<<std::endl;    
        }
